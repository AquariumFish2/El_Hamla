...
namespace El_Hamla
{
    public partial class ST_buying_edit : Form
    {
        public ST_buying_edit()
        {
            InitializeComponent();
        }
        ...
        {
            this.Close();
            buying_show Show = new buying_show();
            Show.ShowDialog(); 
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("هل تريد حذف هذا الصنف", "   حذف صنف  " + dvg10.CurrentRow.Cells[0].Value.ToString(), MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                try
                {
        ...
        private void buying_edit_Load(object sender, EventArgs e)
        {
            textBox7.Text = textBox1_in_buying_edit.Text;
            ...
            CLSbuying b111 = new CLSbuying();
            b111.load_b111(Convert.ToInt32(textBox1_in_buying_edit.Text));
            dataGridView3.DataSource = b111.dtb111;

            dataGridView3.Columns[0].HeaderText = "أسم الصنف";
            dataGridView3.Columns[1].HeaderText = "الوحدة";
            dataGridView3.Columns[2].HeaderText = "السعر";
            dataGridView3.Columns[3].HeaderText = "الكمية";


            dateTimePicker1.Text = dataGridView3.Rows[0].Cells[1].Value.ToString();
            textBox17.Text = dataGridView3.Rows[0].Cells[3].Value.ToString();
            ...
            dr_b[1] = dataGridView3.Rows[0].Cells[2].Value.ToString(); ;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            cLSbuying.update_buying(Convert.ToInt32(textBox1_in_buying_edit.Text), Convert.ToDateTime(textBox18.Text), textBox14.Text, Convert.ToDecimal(textBox17.Text));
